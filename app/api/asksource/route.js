...
export async function POST(req) {
    try {
        ...
        switch (searchMode) {
            case 'simple':
                targetUrl = `${backendUrl}/api/v1/nlp/index/answer_search/${projectId}`;
                payload = {
                    text: prompt,
                    limit: limit || 2
                };
            ...
            case 'hybrid':
                targetUrl = `${backendUrl}/api/v1/nlp/index/answer_hybrid/${projectId}`;
                payload = {
                    text: prompt,
            ...
            case 'advanced':
                targetUrl = `${backendUrl}/api/v1/nlp/index/answer_hybrid_cross/${projectId}`;
                payload = {
                    text: prompt,
                    dense_limit: denseLimit || 10,
