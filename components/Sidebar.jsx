...
const Sidebar = ({expand, setExpand}) => {
  ...
  return (
    ...
    <div className={`mt-8 text-gray-500 text-sm font-semibold ${expand ? "block" : "hidden"}`}> {/* Couleur du texte des titres secondaires modifiée */}
            ...
            {/* Bloc Get App supprimé pour simplifier l'interface */}
