...
const ChatLabel = ({openMenu, setOpenMenu, id, name}) => {
  ...
  return (
  <div onClick={selectChat} className='flex items-center justify-between p-2 text-gray-700 hover:bg-white/10 rounded-lg text-sm group cursor-pointer'> {/* Couleur du texte du titre de chat modifiée */}
  ...
  <div className={`absolute ${openMenu.id === id && openMenu.open ? 'block' : 'hidden'} -right-36 top-6 bg-white border shadow-lg rounded-xl w-max p-2`}> {/* Couleur et style du menu contextuel modifiés */}
